...
DATASET_PARAMETERS = {
    ...
    'meta_file': 'data/voclexb-vgg-dataset/vox1_meta.csv',   # face person
    # RAVDESS datase csv
    'wave_file': 'data/RAVDESS/wave_list.csv',
    'image_file': 'data/RAVDESS/image_list.csv',

    # voice dataset
    'voice_dir': 'data/voclexb-vgg-dataset/fbank',
    'voice_ext': 'npy',

    # face dataset
    'face_dir': 'data/voclexb-vgg-dataset/VGG_ALL_FRONTAL',
    'face_ext': '.jpg',
...
NETWORKS_PARAMETERS = {
    ...
    'g': {
        ...
        'model_path': 'models/generator.pth',      # 生成
    },
    ...
    'f': {
        ...
        'output_channel': 64,
        'model_path': 'models/face_embedding.pth', # 无
    },
    # DISCRIMINATOR (d)
    'd': {
    ...
    'c': {
        ...
        'model_path': 'models/classifier.pth',  # 无
    },
